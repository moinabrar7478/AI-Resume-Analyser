...
# sql connector
connection = pymysql.connect(host='localhost',user='root',password='moin@7478',db='cv')
...
def run():
    ...
    link = '<b>Built with 🤍 by <a href="https://www.linkedin.com/in/moinuzzaman-ansari-9826ba240/" style="text-decoration: none; color: #021659;">MOIN & GALIB</a></b>' 
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        st.subheader("**About The Tool - AI RESUME Enhancer**")
        ...
        <p align="justify">
            ...
            <b>Admin -</b> <br/>
            For login use <b>admin</b> as username and <b>admin@resume-Enhancer</b> as password.<br/>
            It will load all the required stuffs and perform analysis.
        </p><br/><br/>

        <p align="justify">
            Built with 🤍 by
            <a href="https://www.linkedin.com/in/moinuzzaman-ansari-9826ba240/" style="text-decoration: none; color: grey;">MOIN</a> through streamlit
        </p>
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            ## Credentials 
            if ad_user == 'admin' and ad_password == 'admin@resume-Enhancer':
                ...
                st.success("Welcome MOIN ! Total %d " % values + " User's Have Used Our Tool : )")                
